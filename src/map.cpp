...
{
    // ZS1 already uses the low 12 bits directly for retail NVID queries.
    // 0x4000 marks the extended 13-bit form for slots 4096..8191.
    return nvid<kRetailVidCapacity ? nvid : (0x4000 | (nvid&0x1FFF));
}
